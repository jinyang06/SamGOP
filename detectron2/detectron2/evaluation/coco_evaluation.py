...
class COCOEvaluator(DatasetEvaluator):
    ...
    def _derive_coco_results(self, coco_eval, iou_type, class_names=None):
        ...
        metrics = {
            "bbox": ["AP", "AP50", "AP75", "AP95","APs", "APm", "APl"],
            "segm": ["AP", "AP50", "AP75", "AP95", "APs", "APm", "APl"],
            "keypoints": ["AP", "AP50", "AP75", "AP95", "APm", "APl"],
        }[iou_type]
...
class COCOevalMaxDets(COCOeval):
    ...
    def summarize(self):
        ...
        def _summarizeDets():
            ...
            stats[3] = _summarize(1, iouThr=0.95, maxDets=self.params.maxDets[2])
