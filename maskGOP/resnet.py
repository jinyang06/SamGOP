...
class ResNet(nn.Module):
    def __init__(self, block, layers, num_classes=1000):
        ...
        self.layer5_scene = self._make_layer(block, 256, layers, stride=1)
        self.layer5_face = self._make_layer_face(block, 256, layers, stride=1)
...
def resnet50(pretrained=False, **kwargs):
    model = ResNet(Bottleneck, 2, **kwargs)
    if pretrained:
