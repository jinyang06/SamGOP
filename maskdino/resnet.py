...
class ResNet(nn.Module):
    def __init__(self, block, layers, num_classes=1000):
        ...
        # GOO additional to resnet50
        self.layer5_scene = self._make_layer(block, 256, layers[4], stride=1)
        self.layer5_face = self._make_layer_face(block, 256, layers[4], stride=1)
