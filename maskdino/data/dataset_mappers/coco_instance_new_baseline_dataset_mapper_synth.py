...
class COCOInstanceNewBaselineDatasetMapper:
    ...
    def __call__(self, dataset_dict):
        ...
        gaze_related_ann['hx'], gaze_related_ann['hy'] = gaze_related_ann['hx'], gaze_related_ann[
            'hy']
        ...
        dataset_dict['no_occluded'] = 1 if dataset_dict['gaze_related_ann']['gazeIdx'] != -1 else 0
        ...
        if "annotations" in dataset_dict:
            ...
            # draw.rectangle(head_box_large[0][0:4].tolist(), fill=None, outline='red', width=3)
