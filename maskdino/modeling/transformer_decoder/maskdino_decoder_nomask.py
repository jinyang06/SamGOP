...
class MaskDINODecoder(nn.Module):
    ...
    def forward(self, x, mask_features, masks, object_mem, object_pos, object_mask, scene_face_feat,targets=None):
        ...
        reference_points = refpoint_embed_gaze.transpose(0, 1).sigmoid().to(device)
